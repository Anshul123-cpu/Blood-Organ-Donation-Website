...
function highlightActiveSection() {
    const sections = ['blood-donation-section', 'organ-donation-section', 'hospital-registration-section', 'nearby-hospitals-section'];
    const navbarItems = document.querySelectorAll('.donation-btn');
    ...
    navbarItems.forEach(item => {
        ...
        if (currentSection && onclickAttr && onclickAttr.includes(currentSection)) {
...
// Hospital selection and filtering functionality
let selectedHospital = null;

function selectHospital(button, hospitalName) {
    ...
    button.closest('.hospital-card').classList.add('selected');
    
    // Update selected hospital
    selectedHospital = hospitalName;
    
    // Show confirmation message
    showNotification(`Hospital "${hospitalName}" selected successfully!`, 'success');
    
    // Store selection (for future backend integration)
...
// Initialize hospital filtering (moved to load event below)
...
class DonationSystem {
    ...
    init() {
        ...
        this.handleHospitalRegistration();
    }
    ...
    handleHospitalRegistration() {
        console.log("handleHospitalRegistration() called");
        const form = document.getElementById('hospitalRegistrationForm');
        
        console.log("Hospital form element:", form);
        
        if (!form) {
            console.log("❌ Form NOT FOUND - hospitalRegistrationForm not in DOM");
            return;
        }
...
window.addEventListener('load', function() {
    ...
    // Initialize the donation system (which includes hospital registration)
    console.log("Creating DonationSystem instance...");
    new DonationSystem();
});
